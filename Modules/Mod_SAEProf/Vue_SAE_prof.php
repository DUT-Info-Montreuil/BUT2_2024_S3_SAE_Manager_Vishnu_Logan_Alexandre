                        ...
                        foreach ($rendus as $rendu) {
                            ...
                            <div class='deposit-item'>
                                <div>
                                    ...
                                    <form id='edit-rendu-form-$id_rendu' style='display: none;' method='POST' action='index.php?module=sae&action=modifierRendu&id=$id_rendu'>                                <input type='hidden' name='projet_id' value='$id_projet'>    
